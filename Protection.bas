...
Private Const IdProduit As Long = 7
Private Const Produit As String = "Giration"
Private Const Guid As String = "{FC3F8592-ED65-45A4-A831-8ECCA40B5A51}"
Private Const Vermaj As Long = 3
Private Const Vermin As Long = 2
Private Const message As String = "its-Giration"
...
Public Const REGKEYINFO = "" 'ne sert pas
Public Const REGVALINFO = "" 'ne sert pas
...
Private Function EcrireTxt(chaine As String, nomfic As String) As Boolean
  Dim fso As Scripting.FileSystemObject, f As Scripting.File
  Dim filenumber As Integer
  Dim nomfichier, myString As String
